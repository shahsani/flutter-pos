...
class AppColors {
  // Primary - Vibrant Orange/Red for POS actions (MokPOS often uses warm accents)
  static const Color primary = Color(0xFFFF6B6B); // Soft Red/Orange
  ...
  // Backgrounds
  static const Color backgroundLight = Color(0xFFF7F9FC); // Very light grey blue
